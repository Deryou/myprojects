...
import com.zda.bmt.adapter.WifiListAdapter;
import com.zda.bmt.bean.WifiItem;
import com.zda.bmt.callback.OnWifiPasswordConfirmCallback;
import com.zda.bmt.callback.ServerCallback;
import com.zda.bmt.gloable.AppConstant;
import com.zda.bmt.receiver.WifiBroadcastReceiver;
        ...
        mWifiAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                if (position < mWifiAdapter.getItemCount() && position >= 0) {
                    //获取当前wifi的SSID
                    final ScanResult scanResult = mWifiAdapter.getData().get(position)
                            .getScanResult();
                                    ...
                                    OnWifiPasswordConfirmCallback() {
                                        ...
                                        public void onConfirm(String password) {
                                            ...
                                            if (!TextUtils.isEmpty(password)) {
                                                try {
                                                    if (mHotspotManager.connectToNet(password,
                                                            scanResult)) {
